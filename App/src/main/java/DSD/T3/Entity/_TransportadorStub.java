...
public class _TransportadorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements DSD.T3.Entity.Transportador
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:DSD/T3/Entity/Transportador:1.0","IDL:DSD/T3/Entity/Pessoa:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = DSD.T3.Entity.TransportadorOperations.class;
	public java.lang.String telefone()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_telefone",true);
					_is = _invoke(_os);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_telefone", _opsClass);
				if( _so == null )
					continue;
				TransportadorOperations _localServant = (TransportadorOperations)_so.servant;
				java.lang.String _result;
				try
				{
					_result = _localServant.telefone();
	...
	public void telefone(java.lang.String a)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_set_telefone",true);
					java.lang.String tmpResult14 = a;
_os.write_string( tmpResult14 );
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_telefone", _opsClass);
				if( _so == null )
					continue;
				TransportadorOperations _localServant = (TransportadorOperations)_so.servant;
				try
				{
					_localServant.telefone(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult15 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult16 = a;
	...
	public void carregamento(int a)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_set_carregamento",true);
					_os.write_long(a);
					_is = _invoke(_os);
					return;
				}
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_carregamento", _opsClass);
				if( _so == null )
					continue;
				TransportadorOperations _localServant = (TransportadorOperations)_so.servant;
				try
				{
					_localServant.carregamento(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult17 = a;
	...
	public int carregamento()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_carregamento",true);
					_is = _invoke(_os);
					return _is.read_long();
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_carregamento", _opsClass);
				if( _so == null )
					continue;
				TransportadorOperations _localServant = (TransportadorOperations)_so.servant;
				int _result;
				try
				{
					_result = _localServant.carregamento();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
